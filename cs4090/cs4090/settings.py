"""
Django settings for cs4090 project.
...
SECRET_KEY = "django-insecure-hehc#+$s^nc0q+awv-3i*75w*b1*k@bo$e3ouzn40$b-l@yo@-"
...
WSGI_APPLICATION = "cs4090.wsgi.application"
